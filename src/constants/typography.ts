import { ArrowRightLeft, AudioLines, BicepsFlexed, BicepsFlexedIcon, Calendar, Clock3, Cog, Cpu, Dumbbell, Factory, FileQuestion, Globe2, GraduationCap, Ham, HeartHandshake, History, Lightbulb, MapPin, MessageCircle, Mountain, Network, Radio, Repeat, SatelliteDish, ShieldCheck, Signal, SignalHigh, SignalLow, Siren, SlidersVertical, Smartphone, Target, Tent, Tractor, Trees, Trophy, Truck, UserCheck, Users, Waves, Wrench, X } from "lucide-react"
...
export const TYPOGRAPHY = {
    ...
    digital: {
        ...
        faq: [
            { question: 'Rádio digital substitui celular?', answer: 'Não substitui totalmente — complementa. Rádios são mais previsíveis e imediatos para coordenação crítica; celulares servem para dados, apps e backhaul.' },
            { question: 'Preciso de licença ANATEL?', answer: 'Sim — a operação em faixas comerciais exige homologação/licenciamento. Nós ajudamos no processo.' },
            { question: 'Quanto custa implantar?', answer: 'Depende: número de sites, repetidoras, infraestrutura e cuidados com backhaul. Melhor resposta: estimativa após estudo de cobertura.' },
            { question: 'Posso usar repetidoras remotas conectadas por internet?', answer: 'Sim — backhaul IP é uma opção comum (com segurança via VPN), útil em áreas com infraestrutura.' }
        ],
    },
    about: {
        intro: {
